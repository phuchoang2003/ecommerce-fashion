...
public class MessageServiceImpl implements MessageService {
    ...
    public Page<Message> getMessages(Long senderId, Long receiverId, Pageable pageable) {
        return messageMongoRepository.findAllMessageLatest(senderId, receiverId, pageable);
